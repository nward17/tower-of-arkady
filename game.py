...
class Level(object):
    ...
    def tutorial(self, surface):
        ...
        fire = font.render('Grab the fire extinguisher to put out this fire.', True, (0, 0, 0))       
...
def gethighscores():
    ...
    with con:
        ...
        cur.executescript("""
            INSERT INTO HighScores VALUES('Acrobatty', 3);
            INSERT INTO HIGHSCORES VALUES('Burnhammer', 3);
            """)
